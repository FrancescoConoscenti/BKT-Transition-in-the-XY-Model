...
\begin{frame}{Energy and Specific Heat}
    \begin{columns}[T] % Align columns at the top
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=0.9\linewidth]{images/xy_model_energy_wolff.png}
            \vspace{0.5em}
            \includegraphics[width=0.9\linewidth]{images/xy_model_specific_heat_wolff.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Magnetization and Susceptibility}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
             \includegraphics[width=0.9\linewidth]{images/xy_model_magnetization_wolff.png}
             \vspace{0.5em}
             \includegraphics[width=0.9\linewidth]{images/xy_model_susceptibility_wolff.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Spin Stiffness (Helicity Modulus $\rho_s$)}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\linewidth]{images/xy_model_stiffness_wolff.png}
            \vspace{0.5em}
            {\tiny Plot shows $\rho_s$ vs $T$ for different $L$. The dashed line is $y = 2k_B T/\pi$.}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Above $T_{KT}$:
                    \begin{itemize}
                        \item Proliferation of free vortices and antivortices.
                        \item Density becomes significant, screening interactions and destroying QLRO.
                    \end{itemize}
                 \item Provides a microscopic view of the transition mechanism.
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\linewidth]{images/xy_model_vortices_wolff.png}
             \vspace{0.5em}
    ...
    \begin{columns}[T] % Align columns at the top
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \\[0.5em]
                $\qquad \mathalert{T_{KT}(\infty) \approx 0.893(4) J / k_B}$
                 \\[0.5em]
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
             \includegraphics[width=\linewidth]{images/xy_model_fss_wolff.png}
             \vspace{0.5em}
