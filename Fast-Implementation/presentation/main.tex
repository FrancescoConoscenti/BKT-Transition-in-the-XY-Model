...
\begin{frame}{Energy and Specific Heat}
    \begin{columns}[T] % Align columns at the top
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=0.9\linewidth]{images/observables/xy_model_energy_wolff.png}
            \vspace{0.5em}
            \includegraphics[width=0.9\linewidth]{images/observables/xy_model_specific_heat_wolff.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Magnetization and Susceptibility}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
             \includegraphics[width=0.9\linewidth]{images/observables/xy_model_magnetization_wolff.png}
             \vspace{0.5em}
             \includegraphics[width=0.9\linewidth]{images/observables/xy_model_susceptibility_wolff.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Vortex Density}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\linewidth]{images/observables/xy_model_vortices_wolff.png}
             \vspace{0.5em}
